...
if ($gate == 'robokassa')
{
  ...
  $response = [
    'success' => true,
    'href' => "https://auth.robokassa.ru/Merchant/Index.aspx?MrchLogin=".ROBOKASSA_SHOP_ID."&OutSum=$sum&InvId=$orderID&Desc=$title&SignatureValue=$crc&Email={$_REQUEST[email]}",
    'gate' => 'robokassa'
  ];
