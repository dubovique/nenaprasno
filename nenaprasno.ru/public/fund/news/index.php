        ...
        <div class="main-wrapper">
            ...
            <div class="main-wrapper-column">
                <div class="publications-block">
                    <?
                        global $filter;
                        $filter = ['PROPERTY_TOP_VALUE' => 'Y', 'PROPERTY_TYPE_VALUE' => 'Новость'];
                        $APPLICATION->IncludeComponent("bitrix:news.list", "mainsite-top-newsblock", array(
                          "FILTER_NAME" => "filter",
                          "IBLOCK_ID" => "25",
                          "NEWS_COUNT" => "3",
                    ...
                    <?
                        ...
                        $filterSmallNews = ['!PROPERTY_TOP_VALUE' => 'Y', 'PROPERTY_TYPE_VALUE' => 'Новость'];
                        $APPLICATION->IncludeComponent("bitrix:news.list", "mainsite-small-newsblock", array(
