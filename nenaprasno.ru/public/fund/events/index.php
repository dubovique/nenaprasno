        ...
        <div class="main-wrapper">
            ...
            <div class="main-wrapper-column">
                <div class="publications-block">
                    <?
                        global $filter;
                        $filter = ['PROPERTY_TOP_VALUE' => 'Y', 'PROPERTY_TYPE_VALUE' => 'Событие'];
                        $APPLICATION->IncludeComponent("bitrix:news.list", "mainsite-top-eventsblock", array(
                          "FILTER_NAME" => "filter",
                          "IBLOCK_ID" => "25",
                          "NEWS_COUNT" => "3",
                          "SORT_BY1" => "ID",
                    ...
                    <?
                        global $filterSmallEvents;
                        $filterSmallEvents = ['!PROPERTY_TOP_VALUE' => 'Y', 'PROPERTY_TYPE_VALUE' => 'Событие'];
                        $APPLICATION->IncludeComponent("bitrix:news.list", "mainsite-small-eventssblock", array(
                          "FILTER_NAME" => "filterSmallEvents",
                          "IBLOCK_ID" => "25",
                          "NEWS_COUNT" => "9",
                          "SORT_BY1" => "ID",
                          "SORT_ORDER1" => "DESC",
